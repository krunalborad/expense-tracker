  ...
  return (
    <div className='flex'>
        <div className='w-screen h-screen md:w-[60vw] px-12 pt-8 pb-12'>
            <h1 className='font-medium text-3xl text-black'>Expense Tracker</h1>
            {children}
        </div>
        ...
        <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
            ...
            <div className='grid grid-cols-1 z-20'>
                ...
                label = "Track your income and expences !"
                value = "50,40,512"
                color = "bg-primary" />
            </div>

            <img src={card2} className='w-64 lg:w-[90%] absolute bottom-17 shadow-lg shadow-blue-400/15'/>
